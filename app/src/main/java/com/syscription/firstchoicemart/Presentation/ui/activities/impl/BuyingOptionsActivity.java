...
import com.syscription.firstchoicemart.Models.ChoiceOption;
...
import com.syscription.firstchoicemart.Presentation.presenters.BuyingOptionPresenter;
import com.syscription.firstchoicemart.Presentation.ui.activities.BuyingOptionView;
import com.syscription.firstchoicemart.Presentation.ui.customui.MyRadioButton;
...
public class BuyingOptionsActivity extends BaseActivity implements BuyingOptionView {
    ...
    private final HashMap<String, String> selectedChoices = new HashMap<>();
    ...
    private void createSelectedChoiceList(String value){
        ...
        String color = selectedChoices.get("color");
