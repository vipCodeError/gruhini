...
import com.syscription.firstchoicemart.Network.response.CartResponse;
import com.syscription.firstchoicemart.Network.services.CartApiInterface;
...
public class CartInteractorImpl extends AbstractInteractor {
    private final CartInteractor.CallBack mCallback;
