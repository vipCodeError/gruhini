...
public class PurchaseHistoryAdapter extends RecyclerView.Adapter<PurchaseHistoryAdapter.ViewHolder> {
    ...
    private final PurchaseHistoryCliclListener purchaseHistoryCliclListener;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView order_code, order_date, order_amount, payment_status, payment_type;
        ...
        public void bind(PurchaseHistory purchaseHistory) {
            ...
            payment_type.setText("Payment Type - " + purchaseHistory.getPaymentType());
